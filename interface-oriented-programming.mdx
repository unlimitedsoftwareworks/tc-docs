---
title: "Type-C Implementations vs Traditional OOP Class Inheritance"
description: "A comparison of Type-C's approach to behavior composition against traditional OOP class inheritance, including examples, pros, and cons."
---
