...
- [Implementations](/docs/datatypes/implementations): Implementations, a group of methods that a class can reuse
...
- [Coroutines](/docs/datatypes/coroutines): Coroutines, lua-like cooperative multitasking
